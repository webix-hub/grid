...
export function grid<T extends webix.ui.baseview>(config:obj, parent?:obj|string, replacement?:obj|string|number):T;
...
export class editor implements webix.ui.baseview{
	adjust():void;
	app(app:obj):void;
